...
import { History, Eye, GitCompare, Loader2, X } from 'lucide-react';
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
type VersionHistoryProps = {
  ...
  useCaseId: string;
  onLoadVersion: (version: VersionEntry) => void;
};

export default function VersionHistory({ isOpen, onOpenChange, useCaseId, onLoadVersion }: VersionHistoryProps) {
    ...
    <Sheet open={isOpen} onOpenChange={(open) => {
      ...
      <SheetContent className="w-full sm:max-w-2xl flex flex-col">
        <SheetHeader>
          ...
          <SheetDescription>
            Previous versions of <span className="font-mono">{useCaseId}</span>. Click View to load a version into the editor, or Diff to compare with the latest.
          </SheetDescription>
        </SheetHeader>
