...
interface UseCaseEmbeddingsRepository : AutoCloseable {
    ...
    suspend fun storeUtterances(id: String, examples: List<String>, tags: Set<String> = emptySet()): Int
    suspend fun storeUseCase(adl: String, examples: List<String> = emptyList(), tags: Set<String> = emptySet()): Int
    suspend fun search(query: String, limit: Int = 5, scoreThreshold: Float = 0.0f, tags: Set<String>? = null): List<SearchResult>
