...
/**
 * Extension function to create a dynamic proxy for the ConversationAgent.
 *
 * Allows casting the ConversationAgent to an interface that accepts an object and returns an object.
 * This wrapper uses the agent's processing logic (ask -> deserialize) similarly to ConversationAgent.process.
 *
